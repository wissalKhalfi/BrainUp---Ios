...
class QuizzLevel4ViewController: UIViewController {
   ...
   // var scoreV: Int!
    ...
    var roundController: RoundController4 = RoundController4()
    ...
    override func viewDidLoad() {
        ...
        loadNoSound()
        // Start game
        roundController = RoundController4(questionsPerRound: numberOfQuestions)
        playGameStartSound()
