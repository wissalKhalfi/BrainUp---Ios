...
class QuizzLevel3ViewController: UIViewController {
   ...
   // var scoreV: Int!
    ...
    var roundController: RoundController3 = RoundController3()
    ...
    override func viewDidLoad() {
        ...
        loadNoSound()
        // Start game
        roundController = RoundController3(questionsPerRound: numberOfQuestions)
        playGameStartSound()
