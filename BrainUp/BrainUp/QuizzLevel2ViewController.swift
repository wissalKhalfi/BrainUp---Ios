...
class QuizzLevel2ViewController: UIViewController {
   ...
   // var scoreV: Int!
    ...
    let numberOfQuestions = 12   //the number of questions per round
    ...
    var roundController: RoundController2 = RoundController2()
    ...
    override func viewDidLoad() {
        ...
        loadNoSound()
        // Start game
        roundController = RoundController2(questionsPerRound: numberOfQuestions)
        playGameStartSound()
    ...
    @IBAction func SocialSharing(_ sender: AnyObject) {
